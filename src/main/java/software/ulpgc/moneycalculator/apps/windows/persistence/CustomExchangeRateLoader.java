package software.ulpgc.moneycalculator.apps.windows.persistence;
...
public class CustomExchangeRateLoader implements ExchangeRateLoader {
    ...
    private String loadJsonFromAPI() throws IOException {
        URL url = new URL("http://api.exchangeratesapi.io/v1/latest?access_key=b5b68aa9d55942208c754952f1820b06");
